# OKSolar Light (colorblind, red-green safe) theme for Nushell
...
$env.config.color_config = {
    ...
    block: "#657377"
    hints: "#8FAAAB"
    search_result: { fg: "#FBF7EF" bg: "#C79A26" }

    shape_and: { fg: "#D56500" attr: "b" }
    ...
    shape_externalarg: { fg: "#D56500" attr: "b" }
    ...
    shape_keyword: { fg: "#D56500" attr: "b" }
    shape_list: { fg: "#259D94" attr: "b" }
    shape_literal: "#2B90D8"
    shape_match_pattern: "#D56500"
    shape_matching_brackets: { attr: "u" }
    shape_nothing: "#DD459D"
    shape_operator: "#D56500"
    shape_or: { fg: "#D56500" attr: "b" }
    shape_pipe: { fg: "#D56500" attr: "b" }
    shape_range: { fg: "#C79A26" attr: "b" }
