# GitHub Light Colorblind theme for Nushell

$env.config.color_config = {
    separator: "#d0d7de"
    leading_trailing_space_bg: { attr: "n" }
    header: { fg: "#0969da" attr: "b" }
    empty: "#0969da"
    bool: {
        true: { fg: "#0969da" }
        false: { fg: "#9a6700" }
    ...
    shape_keyword: { fg: "#9a6700" attr: "b" }
    shape_list: { fg: "#1b7c83" attr: "b" }
    shape_literal: "#0969da"
    shape_match_pattern: "#0969da"
    shape_matching_brackets: { attr: "u" }
    shape_nothing: "#0550ae"
    shape_operator: "#9a6700"
    ...
    shape_signature: { fg: "#0969da" attr: "b" }
    shape_string: "#0a3069"
